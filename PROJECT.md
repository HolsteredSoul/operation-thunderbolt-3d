...
- **Last done:** Completed the requested unit-readability pass: distinct Blender silhouettes, equipment, postures and colors; role names on aim; targeting verified for each enemy. See VERIFICATION.md.
- **Next action:** User review only. Do not start another polish cycle without a request.
- **Synced to:** Role-readability implementation commit — 2026-09-06 (see git log).
